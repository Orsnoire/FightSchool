...
- **Dynamic Enemy HP Scaling**: Enemy HP scales automatically based on class size and player progression. Formula: `Base HP = (questions + total player levels + 10) / 10 × difficultyMultiplier`. Teachers set a difficulty multiplier (1-100) per enemy, where 1-10 = trash pack (1-2 rounds), 11-30 = elite, 31-60 = boss, and 61-100 = epic boss. This ensures fights remain balanced whether 2 or 20 students participate.
